...
import { getAllRooms,removeRoom } from "../Api";
...
const removeData=async(id)=>{
	...
	try {
		console.log(id)
		await removeRoom(id).then((response)=>{
...
return (
	...
	<div className="table-wrapper" style={{maxWidth:"1215px",marginLeft:"320px"}}>
		...
		<button className="bg-primary" onClick={getData} style={{padding:"10px",borderRadius:"7px",color:"white" ,fontWeight:"bolder",marginTop:"20px",marginLeft:"26px"}}>Get Rooms</button>
		<Link to="/addRoom">
		<button className="bg-success"style={{padding:"10px",borderRadius:"7px",color:"white" ,fontWeight:"bolder",marginTop:"20px",marginLeft:"26px"}}>Add Room</button>

		</Link>
		<button className="bg-warning" onClick={7} style={{padding:"10px",borderRadius:"7px",color:"white" ,fontWeight:"bolder",marginTop:"20px",marginLeft:"26px"}}>Update</button>
...
<tr >
  ...
  <button className="bg-warning" style={{padding:"7px",borderRadius:"10px",color:"white",justifyContent:"center"}}><b>Update Room</b></button>
  </Link>
  </td>
